...
!(function (t, e) {
    ...
    function xe(t, e, i) {
        ...
        e &&
            be(t) &&
            ((s = (t.offsetWidth > 0 && Te(n.width) / t.offsetWidth) || 1), (o = (t.offsetHeight > 0 && Te(n.height) / t.offsetHeight) || 1));
    ...
    function Re(t) {
        ...
        if (c) {
            ...
            A === ge(i) && "static" !== Se((A = $e(i))).position && "absolute" === a && ((E = "scrollHeight"), (T = "scrollWidth")),
                (s === Vt || ((s === Xt || s === Qt) && o === Jt)) &&
                    ((y = Kt), (m -= (d && A === w && w.visualViewport ? w.visualViewport.height : A[E]) - n.height), (m *= l ? 1 : -1)),
                (s !== Xt && ((s !== Vt && s !== Kt) || o !== Jt)) ||
            ...
            null != e.modifiersData.popperOffsets &&
                ...
                null != e.modifiersData.arrow &&
                    (e.styles.arrow = Object.assign(
                        {},
                        e.styles.arrow,
                        Re(Object.assign({}, c, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: l }))
                    )),
            ...
            : ii(
                  (function (t) {
                      var e,
                          ...
                          l = -n.scrollTop;
                      return (
                          "rtl" === Se(s || i).direction && (a += Ae(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
                      );
                  })($e(t))
              );
    }
                ...
                for (
                    var s = i.mainAxis,
                        ...
                        v = [g].concat(b).reduce(function (t, i) {
                            return t.concat(
                                we(i) === Yt
                                    ? ri(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: m })
                                    : i
                            );
                        }, []),
                        y = e.rects.reference,
                ...
                h = {
                    ...
                    setOptions: function (i) {
                        ...
                        d(),
                            ...
                            (a.scrollParents = { reference: _e(t) ? ei(t) : t.contextElement ? ei(t.contextElement) : [], popper: ei(e) });
                        var r,
                            c,
                            u = (function (t) {
                                var e = mi(t);
