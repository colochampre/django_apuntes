...
if not SECRET_KEY:
    if DEBUG:
        # Clave insegura por defecto SOLO para desarrollo
        SECRET_KEY = "django-insecure-emks*vu&0n73h89i8-s4olpc5k78*yenehaw2%@drd^&*#84h("
    else:
        # En producción, es obligatorio definir una SECRET_KEY segura
        from django.core.exceptions import ImproperlyConfigured
        raise ImproperlyConfigured("La variable DJANGO_SECRET_KEY es obligatoria en producción.")
